...
# -*- coding: utf-8 -*-
#
# yourls documentation build configuration file.
#
...
latex_documents = [
    ('index', 'yourls.tex', 'yourls Documentation', AUTHOR, 'manual'),
]
...
man_pages = [
    ('index', 'yourls', 'yourls Documentation',
     [AUTHOR], 1)
]
...
texinfo_documents = [
    ('index', 'yourls', 'yourls Documentation', AUTHOR, 'yourls',
...
inheritance_graph_attrs = dict(bgcolor='transparent', rankdir="TB")
